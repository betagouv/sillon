...
_Vous verrez dans le chapitre sur [le framework backend](backend-framework/index.mdx) que nous n'utilisons même pas besoin de librairie tierce pour gérer l'état de nos composants frontends._
