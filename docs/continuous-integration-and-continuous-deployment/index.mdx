...
Nous préconisons d'utiliser une pipeline de [CI/CD](https://en.wikipedia.org/wiki/CI/CD) décrite dans votre repository. Si votre repository est par exemple sur GitHub nous ne voyons pas l'utilité d'utiliser un outil tiers comme [CircleCI](https://circleci.com/) plutôt que [GitHub Actions](https://github.com/features/actions) (comme ça au moins vous avez tout dans un même endroit).
