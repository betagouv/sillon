...
Par chance vous aurez [mis en place des backups](#backups) mais entre le dernier backup et la perte des données il va être très dur de reconstituer ce qui manque (voire impossible).
