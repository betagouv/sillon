...
Comme mentionné pour [la documentation de la base de données](document/database-schema.mdx), nous utilisons le client [DBeaver](https://dbeaver.io/) au quotidien.
