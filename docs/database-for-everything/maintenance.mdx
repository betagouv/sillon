...
Comme mentionné pour [la documentation de la base de données](#le-schéma-de-base-de-données), nous utilisons le client [DBeaver](https://dbeaver.io/) au quotidien.
