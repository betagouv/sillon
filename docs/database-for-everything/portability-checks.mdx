...
Mais si jamais vous complexifiez votre stack stateful et que chez un provider au hasard vous utilisez des buckets S3 et un message broker managé, on se retrouverait dans la situation où :
