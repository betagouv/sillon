...
- On peut ainsi enlever quelques intermédiaires [en mettant en relation les beta-testeurs et un développeur](#faire-la-vigie-en-étant-outillé). Comme ça si une erreur technique apparaît, pas besoin de faire le téléphone arabe, on parle directement à la personne concernée.
