...
- On peut ainsi enlever quelques intermédiaires [en mettant en relation les beta-testeurs et un développeur](/docs/monitoring). Comme ça si une erreur technique apparaît, pas besoin de faire le téléphone arabe, on parle directement à la personne concernée.
