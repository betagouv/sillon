...
:::tip
Nous recommandons d'utiliser [`date-fns`](https://date-fns.org/) pour le formatage des dates et des intervalles. Ils permettent quelques raccourcis comme `PPPP` ou encore `PPPPpp` ([voir leurs exemples](https://date-fns.org/v2.29.3/docs/format)).
:::
