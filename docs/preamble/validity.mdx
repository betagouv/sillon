...
_Comme cela reste subjectif, il est possible que ce guide vous irrite car mettant en avant des choses que vous n'approuvez pas_ 😠😡🤬*. Essayez alors de remettre dans le contexte “faire simple avec peu de ressources” pour relativiser… Et si vous pensez encore qu'on est dans le faux, n'hésitez pas à nous proposer des améliorations en les partageant via la messagerie.*
