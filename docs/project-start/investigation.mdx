...
Pour faire connexion avec [le chapitre sur les coûts liés au temps](project-start/time-and-costs.mdx), il faut garder en tête la gradation suivante qui définit aussi le temps nécessaire pour chaque étape d'un produit (du plus court au plus long) :
