...
- Dans le cas où c'est un service privé, jauger si ça vaut vraiment le coup de développer une solution en interne comme expliqué dans [_les coûts liés au temps_](#réfléchir-aux-coûts-liés-au-temps). C'est un arbitrage très souvent lié à vos spécificités métiers non présentes dans l'outil.
