...
**L'idée d'un projet a de grandes chances de répondre à un besoin si elle émane d'un potentiel utilisateur.** _Donc restez vigilant aux demandes de réalisation d'un projet qui sortent de nul part…_
