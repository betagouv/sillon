...
Nous vous recommandons d'utiliser des outils comme [_Figma_](https://www.figma.com/) ou [_Penpot_](https://penpot.app/) pour faciliter le travail et la collaboration. L'idée dans cet outil sera de :

1.  Créer tous les écrans qui existent dans votre applicatif ;
2.  Créer des liens entre chaque écran afin de comprendre les flows possibles (cela servira pour faire des “[_wireframes_](<https://fr.wikipedia.org/wiki/Wireframe_(design)>) animés”, c'est-à-dire des pseudo-démos) ;
...
_Toujours dans cette notion de validation en cycles, si vous aviez maquetté des écrans grossièrement pour valider la partie “UX design”, il est important une fois le “UI design” mis en place de le repartager avec vos beta-testeurs._
