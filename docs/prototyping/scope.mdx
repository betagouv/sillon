...
**Si votre produit semble très conséquent après l'atelier, il va être nécessaire de privilégier les fonctionnalités indispensables pour rendre cela digeste afin [d'en développer une version minimale](#produit-minimum-viable).** Pour autant, gardez tout le contenu établi car il vous sera utile pour travailler ces potentielles futures fonctionnalités.
