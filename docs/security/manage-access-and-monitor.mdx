...
Vous pouvez aussi utiliser un outil comme [_GitGuardian_](https://www.gitguardian.com/) pour vous prémunir de secrets qui seraient committés sans faire exprès sur votre repository (promis, ça arrive 😬).
