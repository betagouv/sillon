...
Pour chaque entreprise privée que vous choisissez, il faut que la fonctionnalité dont vous avez besoin se base sur des standards _(nous excluons les projets de niches qui font de la [R&D](https://fr.wikipedia.org/wiki/Recherche_et_d%C3%A9veloppement) et où les standards peuvent ne pas encore exister)_.
