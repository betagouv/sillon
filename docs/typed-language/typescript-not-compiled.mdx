...
2.  Le typage devient une vue de l'esprit puisqu'au runtime tout est permis (vu que c'est transpilé en JavaScript) :
    1.  Un code TypeScript peut très bien ne pas respecter les types (il “[_caste_](https://en.wikipedia.org/wiki/Type_conversion)” les variables) ;
