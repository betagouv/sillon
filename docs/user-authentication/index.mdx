...
- Reposer sur un standard sécurisé comme [OpenID Connect](https://fr.wikipedia.org/wiki/OpenID_Connect) (OIDC), ou [SAML](https://en.wikipedia.org/wiki/SAML_2.0) pour des systèmes plus historiques.
