...
:::note Quid des autres ?
[Vue.js](https://vuejs.org/) pourrait être une alternative mais son principal problème est de proposer son propre templating par défaut, ne faisant pas le lien avec le code métier. Il y a toujours la possibilité d'utiliser du JSX de façon optionel, ce qui nous trouvons regrettable. De plus, avec la version "Vue 3" leur syntaxe a complètement changé et on se rapproche de ce que fait React depuis longtemps.
:::
